    ...
    \begin{center}
        ...
        \begin{minipage}[t][6cm][t]{0.5\textwidth}
            ...
            \resizebox{1.2\textwidth}{!}{
                ...
                \\ \hline
                \multicolumn{1}{|c|}{281,462} & \multicolumn{1}{c|}{6,894} & \multicolumn{1}{c|}{6,851} & \multicolumn{1}{c|}{4,970} & \multicolumn{1}{c|}{3,420} & \multicolumn{1}{c|}{1,465} & \multicolumn{1}{c|}{623} & \multicolumn{1}{c|}{621} & \multicolumn{1}{c|}{371} & \multicolumn{1}{c|}{42}
                \\ \hline
                \end{tabular}
                \end{table}
        ...
        \begin{minipage}[t][6cm][t]{0.5\textwidth}
            ...
            \resizebox{0.5\textwidth}{!}{
                ...
                \\ \hline
                \multicolumn{1}{|c|}{281,462} & \multicolumn{1}{c|}{15,284} & \multicolumn{1}{c|}{7,472} & \multicolumn{1}{c|}{1,507} & \multicolumn{1}{c|}{994}
                \\ \hline
                \end{tabular}
                \end{table}
                \caption{Counts for each attack category.}
